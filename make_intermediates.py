...
### Read in excel data
try:
    WIOT1997 = pd.read_excel('@Import/data_raw/WIOT/WIOT97_ROW_Apr12.xlsx')
    Description = pd.read_stata('@Import/data_raw/Ding_data/WIOT_MK_97_finalcode_desc.dta')
...
scipy.io.savemat("@Import/data_intermediate/WIOT1997.mat", mdic)

#%%
### Read in excel data for WIOT SEA data (everything in millions)
years = np.arange(1995, 2010)
try:
    SEA = pd.read_excel('@Import/data_raw/WIOT/Socio_Economic_Accounts_July14.xlsx', sheet_name='DATA')
...
scipy.io.savemat("@Import/data_intermediate/SEA1997.mat", mdic1)
# %%


### Create the rest of the WIOT
'''
...
### Read in excel data
years = np.arange(1995, 2010)
path = "@Import/data_raw/WIOT/"
try:
    WIOT1995 = pd.read_excel(path+'WIOTS_in_EXCEL/WIOT95_ROW_Apr12.xlsx')
    WIOT1996 = pd.read_excel(path+'WIOTS_in_EXCEL/WIOT96_ROW_Apr12.xlsx')
    WIOT1997 = pd.read_excel(path+'WIOTS_in_EXCEL/WIOT97_ROW_Apr12.xlsx')
    WIOT1998 = pd.read_excel(path+'WIOTS_in_EXCEL/WIOT98_ROW_Apr12.xlsx')
    WIOT1999 = pd.read_excel(path+'WIOTS_in_EXCEL/WIOT99_ROW_Apr12.xlsx')
    WIOT2000 = pd.read_excel(path+'WIOTS_in_EXCEL/WIOT00_ROW_Apr12.xlsx')
    WIOT2001 = pd.read_excel(path+'WIOTS_in_EXCEL/WIOT01_ROW_Apr12.xlsx')
    WIOT2002 = pd.read_excel(path+'WIOTS_in_EXCEL/WIOT02_ROW_Apr12.xlsx')
    WIOT2003 = pd.read_excel(path+'WIOTS_in_EXCEL/WIOT03_ROW_Apr12.xlsx')
    WIOT2004 = pd.read_excel(path+'WIOTS_in_EXCEL/WIOT04_ROW_Apr12.xlsx')
    WIOT2005 = pd.read_excel(path+'WIOTS_in_EXCEL/WIOT05_ROW_Apr12.xlsx')
    WIOT2006 = pd.read_excel(path+'WIOTS_in_EXCEL/WIOT06_ROW_Apr12.xlsx')
    WIOT2007 = pd.read_excel(path+'WIOTS_in_EXCEL/WIOT07_ROW_Apr12.xlsx')
    WIOT2008 = pd.read_excel(path+'WIOTS_in_EXCEL/WIOT08_ROW_Sep12.xlsx')
    WIOT2009 = pd.read_excel(path+'WIOTS_in_EXCEL/WIOT09_ROW_Sep12.xlsx')
...
### Export values to mat file
mdic = {'VA': vec_list[0], 'grossout': vec_list[1], 'Inventory': mat_list[0], 'IO': IO, 'consumption': mat_list[1], 'GFCF': mat_list[2]}
scipy.io.savemat("@Import/data_intermediate/WIOT95_09.mat", mdic)
...
scipy.io.savemat("@Import/data_intermediate/SEA95_09.mat", mdic1)
# %%
